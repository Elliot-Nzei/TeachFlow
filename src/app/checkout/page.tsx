...
function CheckoutPageContent() {
    ...
    const handleSuccess = async (reference: { reference: string }) => {
        toast({
            ...
            description: `Your payment was completed. We are confirming your order...`
        });

        // This should be called for BOTH subscriptions and product purchases
        const verifyResponse = await fetch('/api/paystack/verify', {
            ...
            body: JSON.stringify({ 
                ...
                userId: user?.uid,
                // Pass relevant data based on purchase type
                ...(isSubscription && {
                    isSubscription: true,
                    planId: productId, // In this context, productId is planId
                    billingCycle,
                }),
                ...(!isSubscription && {
        ...
        if (verifyResult.success) {
            ...
            if (isSubscription) {
             ...
             toast({
                ...
                description: verifyResult.message || 'There was an issue confirming your purchase.',
            });
        }
    };
